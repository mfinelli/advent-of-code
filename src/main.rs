...
fn main() {
    ...
    match problem_lookup.as_str() {
        ...
        "y25d03" => {
            part1 = format!("{}", y25d03::y25d03(&input, 2));
            part2 = format!("{}", y25d03::y25d03(&input, 12));
        }
        "y25d04" => {
            part1 = format!("{}", y25d04::y25d04(&input, 1));
            part2 = format!("{}", y25d04::y25d04(&input, 2));
        }
        "y25d05" => {
            part1 = format!("{}", y25d05::y25d05(&input));
            part2 = "".to_string();
        }
